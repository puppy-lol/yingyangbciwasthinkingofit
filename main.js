...
scoreRightWrist = 0;
var gameStatus = "";
// Done Define a variable to hold the status of the game
...
function draw(){
if(gameStatus == "start") // Done inside the if condition check if the game_status is equal to the value "start".
{
  background(0); 
